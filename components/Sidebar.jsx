...
function Sidebar() {
  ...
  return (
    ...
    <div >
{/* //  <!--Sidebar--> */}
        <div className="w-full md:w-1/5   bg-[#000000f3] md:bg-[#000000ec] z-20 px-0 text-center
                ...
                <ul className="list-reset flex flex-row md:flex-col z-20 text-center md:text-center">
                        <Link href='/'>
                            <li className="mr-3 flex-1  ">
                                <a  className="block py-1 md:py-3   pl-1 align-middle text-[#fff]  hover:text-[#60724b]
                                 hover:bg-[#60724b]   hover:shadow-[#60724b3a] no-underline  border-b-2 border-[#94A3B8]
                        ...
                        <Link href='/services'>
                            ...
                            <li    className="mr-3 flex-1 ">
                                ...
                                <i className=" pr-0 md:pr-3"></i>
                                <span className="pb-1 md:pb-0 text-xs md:text-base text-[#94A3B8] hover:text-[#fff]
                                 md:text-[#fff] block md:inline-block tracking-wide font-[arial]">Services</span>
                                 </a>
                            </li>
                        </Link>
                        ...
                        <Link href='/about'>
                            <li className="mr-3 flex-1">
                                <a  className="block py-1 md:py-3   pl-1 align-middle text-[#fff]  hover:text-[#60724b]
                                    ...
                                    <i className="pr-0 md:pr-3"></i>
                                    <span className="pb-1 md:pb-0 text-xs md:text-base text-[#94A3B8] hover:text-[#fff] 
                                    md:text-[#fff] block md:inline-block tracking-wide font-[arial]">About</span>
                                </a>
                            </li>
                        </Link>
                </ul>
